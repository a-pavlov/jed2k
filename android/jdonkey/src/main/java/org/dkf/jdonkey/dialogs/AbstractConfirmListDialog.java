...
abstract class AbstractConfirmListDialog<T> extends AbstractDialog implements
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AbstractConfirmListDialog.class);
    ...
    private Logger LOGGER = LoggerFactory.getLogger(AbstractConfirmListDialog.class);
