...
CLASS_HOME="/home/apavlov/dev/jed2k/core/target"
...
do_exec()
{
    $EXEC -debug -nodetach -Djava.util.logging.config.file=/home/apavlov/dev/jed2k/core/src/main/resources/logging.properties -home $JAVA_HOME -procname $PROCNAME -cp $CLASS_PATH  -pidfile $PID $1 $CLASS $OPTIONS
}
